...
const RoyaltyNFT = artifacts.require("contracts/marketplace/direct/BaseCappedRoyaltyNFT.sol:BaseCappedRoyaltyNFT")

contract("::BaseCappedRoyaltyNFT", async (accounts) => {
    let royaltyNFT
    ...
    before(async () => {
        royaltyNFT = await RoyaltyNFT.new("RoyaltyNFT", "RNFT", "", 5, owner, 1, { from: owner })
    })
