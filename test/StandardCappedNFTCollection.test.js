...
describe("StandardCappedNFTCollection", function () {
  let NFT, nftContract, owner, addr1, addr2, cap;

  beforeEach(async () => {
    cap = 10;
    NFT = await ethers.getContractFactory("StandardCappedNFTCollection");
    [owner, addr1, addr2, _] = await ethers.getSigners();
    nftContract = await NFT.deploy("TestNFT", "TNFT", "https://example.com/", cap);
