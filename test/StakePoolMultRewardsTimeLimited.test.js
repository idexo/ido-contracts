...
contract("::StakePoolMultRewardsTimeLimited", async (accounts) => {
    ...
    before(async () => {
        const minPoolStakeAmount = web3.utils.toWei(new BN(1000))
    ...
    describe("# Get Contract info", async () => {
        ...
        it("should get minPoolStakeAmount", async () => {
            await stakePool.minPoolStakeAmount().then((res) => {
                expect(res.toString()).to.eq(web3.utils.toWei(new BN(1000)).toString())
            })
        })
        it("should get minPoolStakeAmount", async () => {
            await stakePool.minPoolStakeAmount().then((res) => {
    ...
    describe("# Staking", async () => {
        ...
        describe("staking", async () => {
            ...
            it("should revert stake 3", async () => {
                describe("reverts if DEPOSIT_TIME_CLOSED", async () => {
