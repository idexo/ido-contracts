...
contract StakePoolMock1 is IStakePool, StakeToken, AccessControl, ReentrancyGuard {
    using SafeERC20 for IERC20;

    bytes32 public constant OPERATOR_ROLE = keccak256("OPERATOR_ROLE");
    uint256 public constant MONTH = 1 days;
    uint256 public constant QUARTER = 2 days;
    uint256 public constant YEAR = 8 days;
