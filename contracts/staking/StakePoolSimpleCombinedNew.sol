...
contract StakePoolSimpleCombinedNew is IStakePoolNew, StakeTokenNew, AccessControl, ReentrancyGuard {
        ...
        override
    {
        ...
        //getStakeInfo(stakeId) in order to get timestamplock value for given stakeId
        //require(timestamplock < block.timestamp, "StakePool#withdraw: STAKE_STILL_LOCKED_FOR_WITHDRAWAL")
