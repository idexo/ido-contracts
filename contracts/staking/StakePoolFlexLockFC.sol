...
import "./StakeTokenFlexLockFC.sol";

contract StakePoolFlexLockFC is StakeTokenFlexLockFC, ReentrancyGuard {
    ...
    constructor(
        ...
        address admin,
        address operator
    ) StakeTokenFlexLockFC(stakeTokenName_, stakeTokenSymbol_, stakeTokenBASEUri_, admin, operator) {
